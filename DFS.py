...
class Ghost(threading.Thread):
    ...
    def dfs(self, start_pos: Tuple[int, int]) -> bool:
        # Sử dụng stack để lưu trữ các đỉnh và đường đi
...
def main():
    ...
    with open('output.txt', 'w', encoding='utf-8') as f:
        f.write("DFS Pathfinding Results\n")
        f.write("=" * 50 + "\n")
